...
class TestModelUser(BaseTest):
    ...
    def test_save_fields_exists_unique_true(self):
        ...
        duplicate_nickname_user.passwd = 'sasasa'
    ...
    def test_save_user_without_fields_with_nullable_false(self):
        ...
        user_without_email.passwd = 'sasasa'
        ...
        user_without_passwd = User()
        user_without_passwd.name = 'isaque'
        user_without_passwd.nickname = 'test_without_passwd'
        user_without_passwd.email = 'test_without_passwd@test.com'
        user_without_passwd.last_name = 'felizardo'

        esperado['msg'] = 'passwd not allow blank'
        resposta = user_without_passwd.save()
